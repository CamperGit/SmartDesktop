...
public class Main extends Application implements Initializable
{
    ...
    public void start(Stage stage) throws Exception
    {
        ...
        //ѕосле загрузки находит таб с пресетами и устанавливает ему пресет равный числу в сохранЄнном файле
    ...
    public void initialize(URL location, ResourceBundle resources)
    {
        ...
        addNewPresetButton.setOnAction((event) ->
        {
            try
            {
                ...
                //ƒаже при устанавлении значени€ в выплывающем списке программно срабатывает обработчик событий дл€ него.
        ...
        imageFileChooserButton.setOnAction(event ->
        {
            ...
            if (result != null)
            {
                ...
                try
                {
                    ...
                    {
                        /**
                         * „тобы иметь только один файл фона и не хранить несколько изображений в разном расширении, что
                         * будет мешать в выборе фона рабочего стола, ведь выбиратьс€ он будет по первому вхождению
                    ...
                    /**
                     * ѕривыборе фотки, очищаем папку с видео, чтобы при последующем запуске у нас открывалась именно фотка
                     */
